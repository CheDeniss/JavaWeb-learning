...
public class SignupServlet extends HttpServlet {
    ...
    @Inject
    public SignupServlet(FormParseService formParseService, FileService fileService) {
...
//                new Gson().toJson( restResponse )
//        );
//        System.out.println("POST from SignupServlet");
//        FormParseResult fpr = formParseService.parse(req);
//        req.setAttribute("formData", fpr.getFields());
        //FormParseResult fpr = formParseService.parse(req);
        //System.out.println("model - " + model.getName());
        String jsonData = new Gson().toJson(model);
        req.setAttribute("formData", jsonData);

        req.setAttribute("page", "signupRes");
